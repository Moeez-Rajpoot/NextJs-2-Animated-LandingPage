...
const Section5 = () => {
  ...
  return (
    <div>
      <div className="relative h-fit w-full bg-center bg-cover flex justify-center items-center overflow-hidden">
        {/* Background Image */}
        <div
          ref={backgroundRef}
        ...
        <div className="z-10 flex flex-col justify-center items-center w-full h-screen overflow-y-auto pt-36 hide-scrollbar">
          ...
          <div className="w-[56%] h-full max-h-[80vh] mb-48 mt-7 flex items-center flex-col pb-36">
            ...
            <div className="flex justify-center items-center w-full space-x-8">
              {/* Card 1 */}
              <div className="bg-white h-[80vh] p-6 rounded-lg flex flex-col items-center shadow-lg w-[40%]">
                ...
                <div className="mr-5 mt-5 flex h-fit">
                  ...
                  <h2 className="h-20 p-1 font-thin text-black text-9xl">0</h2>
                </div>
              ...
              <div className="bg-white h-[80vh] p-6 rounded-lg flex flex-col items-center shadow-lg w-[40%]">
                ...
                <div className="mr-5 mt-5 flex h-fit">
                  ...
                  <h2 className="h-20 p-1 font-thin text-black text-9xl">6</h2>
                </div>
